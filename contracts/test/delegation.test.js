...
describe("EIP7702DelegationManager", function () {
  ...
  describe("Deployment", function () {
    ...
    it("Should initialize with correct parameters", async function () {
      ...
      expect(Number(await delegationManager.maxDelegationDuration())).to.equal(365 * 24 * 3600);
      expect(Number(await delegationManager.minDelegationDuration())).to.equal(3600);
    });
  });
